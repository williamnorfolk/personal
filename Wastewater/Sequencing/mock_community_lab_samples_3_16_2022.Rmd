---
title: "mock_community_lab_samples_3_16_2022"
...
filenames_midnight <- list.files("./raw_data/Midnight_3_16_22", pattern="*tsv", full.names=TRUE)
filenames_varskip <- list.files("./raw_data/Varskip_3_16_22", pattern="*tsv", full.names=TRUE)
filenames_v4 <- list.files("./raw_data/V4_3_16_22", pattern="*tsv", full.names=TRUE)
...
```{r}
#save as RDS
saveRDS(monster_mash_mock, "./monster_mash_mock_3_16_22.rds")

monster_mash <- readRDS("./monster_mash_mock_3_16_22.rds")
```
...
ref_info <- read_excel("./mock_ref_data_3_16_22.xlsx", 1)
