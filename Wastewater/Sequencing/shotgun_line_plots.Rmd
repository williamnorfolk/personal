...
```{r}
spades_clean <- readRDS("./raw_data/spades_clean_shotgun.rds")
bwa_clean <- readRDS("./raw_data/bwa_clean_shotgun.rds")
irma_clean <- readRDS("./raw_data/irma_clean_shotgun.rds") %>%
